...
**Notable Changes**
- Dropped saplings will no longer replant themselves when close to despawning.
- Turned off Rat Griefing. <br />
  ^ (Should've been off already, but oh well.)
- (!) Changes in mod updates not noted here, as always.


**Notable Fixes**
- Fixed the loading screen tips not being randomized properly.
- (!) Quite a few fixes with mod updates.
...
**Full changelog [here](https://github.com/The-Nexus-Project/Limitless-7/blob/main/changelogs.md#v0140)!**
...
**Fixes**
- **Fixed** a **world timeout freeze crashing issue**.
...
**Fixes**
- A "**rare**" **crash** while **booting** up the **modpack** on **some systems** is now **fixed**.
- **Enderman Mob** causing **crashes** within **claimed chunks** is now **fixed**.
- **Crashes** related to **Everlasting Abilities** is now **fixed**.
...
**Removed**
- [Shulker Box Tooltip](https://www.curseforge.com/minecraft/mc-mods/shulkerboxtooltip) (**Crashes**.)


**Changes**
- Disabled **@Cyclic's Emerald gear/tools** in favour of **@Pickle Tweaks equivalent**.
...
**Updated**
- **Forge** from version **47.0.3** to **47.0.19**
- All **mods** that **could** be **updated** have been **updated**.
...
**Notes**
- **Keybinds** getting **reset** upon **every boot**. Which **adds** even more **key conflicts** than **first install** and **boot**.
- **Servers** added to the "**Play Multiplayer**" list will not correctly **ping** and display **MOTD**.
- Expect **breaking updates**, some **issues**, **bugs**, **recipe conflicts** & overall **instability**.
...
**Lots of mod additions. Some changes & fixes in mod updates!**
...
- [Lost Souls](https://www.curseforge.com/minecraft/mc-mods/lost-souls)
- [Re-Chiseled](https://www.curseforge.com/minecraft/mc-mods/rechiseled)
- [RFTools Base](https://www.curseforge.com/minecraft/mc-mods/rftools-base) (+ [McJtyLib](https://www.curseforge.com/minecraft/mc-mods/mcjtylib))
...
**Fixes**
- Fixed **Discord Rich Presence** status.
- Some **fixes** in **mod updates**, as **always**.
